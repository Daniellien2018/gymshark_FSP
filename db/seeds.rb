...
ApplicationRecord.transaction do 
    ...
    p24 = Product.create(name: "Adapt Ombre Seamless Leggings", price: 60.00, category: "Womens",  description: "The collection made for lifting, feel confidence that never fades in the latest Adapt Ombre. Sweat-wicking finishing, seamless stretch fabric and zero-distraction designs lets you lift in comfort and support every day, in every way.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/4-Adapt+Ombre+Triangle+Seamless+Leggings.png')
    p24.photo.attach(io: file, filename: '4-Adapt+Ombre+Triangle+Seamless+Leggings.png')

    p25 = Product.create(name: "Vital Seamless 2.0 Shorts", price: 40.00, category: "Womens",  description: "Whatever conditioning means to you, Vital's got something to help you feel, and perform, your best. Seamless designs mean comfort and confidence from workout to time out. Lightweight fabrics in the looser designs mean fewer distractions. And sweat-wicking tech paired with breathable marl mesh dots mean you'll be cool, dry and focused on the days you're moving more. Because you can do it all, and so can Vital.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/5-Vital+Seamless+W+Short.png')
    p25.photo.attach(io: file, filename: '5-Vital+Seamless+W+Short.png')

    p26 = Product.create(name: "Vital Seamless 2.0 Long Sleeve Crop Top", price: 40.00, category: "Womens",  description: "Whatever conditioning means to you, Vital's got something to help you feel, and perform, your best. Seamless designs mean comfort and confidence from workout to time out. Lightweight fabrics in the looser designs mean fewer distractions. And sweat-wicking tech paired with breathable marl mesh dots mean you'll be cool, dry and focused on the days you're moving more. Because you can do it all, and so can Vital.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/6-Vital+Seamless+2.0+Long+Sleeve+Crop+Top.png')
    p26.photo.attach(io: file, filename: '6-Vital+Seamless+2.0+Long+Sleeve+Crop+Top.png')

    p27 = Product.create(name: "Fraction Crop Top", price: 40.00, category: "Womens",  description: "Whatever your workout, the Fraction Crop Top can be a part of your journey. With a loose fit and drop armholes to give you both breathability and ability to move without any restrictions.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/7-Fraction+Crop+Top.png')
    p27.photo.attach(io: file, filename: '7-Fraction+Crop+Top.png')

    p28 = Product.create(name: "Training Long Sleeve Crop Top", price: 26.00, category: "Womens",  description: "Long sleeves, cropped length, the perfect combination. The Training Long Sleeve Crop Top has been carefully designed to be figure-flattering and functional with long raglan sleeves, a crew neck and thumbholes.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/8-Training+Long+Sleeve+Crop+Top.png')
    p28.photo.attach(io: file, filename: '8-Training+Long+Sleeve+Crop+Top.png')

    p29 = Product.create(name: "Wtflex Cyborg Seamless Sports Bra", price: 45.00, category: "Womens",  description: "WTFlex is back by unpopular demand. Same Flex features you know and love, now in even madder shades and styles you can hate on all over again.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/9-Wtflex+Cyborg+Seamless+Sports+Bra.png')
    p29.photo.attach(io: file, filename: '9-Wtflex+Cyborg+Seamless+Sports+Bra.png')
    
    p30 = Product.create(name: "Adapt Fleck Seamless Sports Bra", price: 45.00, category: "Womens",  description: "The collection made for lifting, flex on your latest fit in Adapt Fleck. Sweat-wicking finishing, seamless stretch fabric and zero-distraction designs lets you lift in comfort and support every day, in every way.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/10Adapt+Fleck+Seamless+Sports+Bra.png')
    p30.photo.attach(io: file, filename: '10Adapt+Fleck+Seamless+Sports+Bra.png')

    p31 = Product.create(name: "Training Boyfriend hoodie", price: 46.00, category: "Womens",  description: "The collection full of colour pop pieces and mix and match designs, Training is your go-to whatever your session. Rely on the simple, sleek designs to carry you through your workout, gym commute and anywhere in between. Go bold and mix and match your favourite colours or build your wardrobe around the basics.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/11-Training+Boyfriend+Hoodie.png')
    p31.photo.attach(io: file, filename: '11-Training+Boyfriend+Hoodie.png')

    p32 = Product.create(name: "Premium Sweats Hoodie", price: 45.00, category: "Womens",  description: "Combine style with comfort in the Rest Day Sweats Hoodie. This versatile hoodie is designed with our thickest, heaviest fabric yet so you can feel the difference when you wear it. The clean aesthetic makes this hoodie the next staple piece in your wardrobe. Wear it to and from the gym, to rest or to warm up - it's suitable for every occasion.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/12-Premium+Sweats+Hoodie.png')
    p32.photo.attach(io: file, filename: '12-Premium+Sweats+Hoodie.png')

    p33 = Product.create(name: "Leg Day Oversized Hoodie", price: 45.00, category: "Womens",  description: "Serious leg day DOMS? We know how you feel. Let everyone in the gym know why youre sticking to shoulders today and walking with a wobble. Still looking good though.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/13-Leg+Day+Oversized+Hoodie.png')
    p33.photo.attach(io: file, filename: '13-Leg+Day+Oversized+Hoodie.png')

    p34 = Product.create(name: "Rest Day Sweats Cropped Pullover", price: 56.00, category: "Womens",  description: "Rest up in Rest Day Sweats. This versatile collection is designed with our thickest, heaviest fabric yet so you can feel the difference when you wear it. The clean aesthetic makes it the next staple look in your wardrobe. Wear your Rest Day Sweats to and from the gym, to warm up, or just about anywhere on your next rest day.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/14-Rest+Day+Sweats+Cropped+Pullover.png')
    p34.photo.attach(io: file, filename: '14-Rest+Day+Sweats+Cropped+Pullover.png')

    p35 = Product.create(name: "Training Hoodie", price: 35.00, category: "Womens",  description: "The perfect grab-and-go hoodie that you know will go with whatever you're wearing. The Training Hoodie is soft, comfy and stylish with a simple design and a subtle Gymshark logo on the chest.")
    file = URI.open('https://gymshark-seed.s3.us-west-1.amazonaws.com/15-Training+Hoodie.png')
    p35.photo.attach(io: file, filename: '15-Training+Hoodie.png')
